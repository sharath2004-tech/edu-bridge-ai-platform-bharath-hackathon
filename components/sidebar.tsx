...
import { BarChart3, BookOpen, ClipboardCheck, Download, FlaskConical, Gamepad2, LayoutDashboard, LogOut, Menu, Settings, Ticket, Users, X } from "lucide-react"
...
const menuItems = [
  ...
  { href: "/student/labs", label: "Science Labs", icon: FlaskConical },
  { href: "/student/challenges", label: "Challenges", icon: Gamepad2 },
  { href: "/student/quizzes", label: "My Quizzes", icon: ClipboardCheck },
  { href: "/student/tickets", label: "Support Tickets", icon: Ticket },
