...
async function POST(req) {
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__User$3e$__["User"].create(userData);
        const payload = {
            id: String(user._id),
            role: user.role,
            name: user.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3aa30a9._.js.map