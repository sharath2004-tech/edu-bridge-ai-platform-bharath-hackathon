...
"[project]/app/api/super-admin/users/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).populate('schoolId', 'name code').populate('classId', 'className section').select('-password -__v').sort({
            createdAt: -1
        }).limit(1000).lean();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10142604._.js.map