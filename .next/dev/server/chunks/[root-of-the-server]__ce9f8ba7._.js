...
"[project]/lib/models/OfflineContent.ts [app-route] (ecmascript) <export default as OfflineContent>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "OfflineContent",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$OfflineContent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$OfflineContent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/models/OfflineContent.ts [app-route] (ecmascript)");
}),
...
"[project]/app/api/student/offline-content/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$OfflineContent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__OfflineContent$3e$__ = __turbopack_context__.i("[project]/lib/models/OfflineContent.ts [app-route] (ecmascript) <export default as OfflineContent>");
...
async function GET(request) {
    try {
        ...
        const downloads = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$OfflineContent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__OfflineContent$3e$__["OfflineContent"].find({
            userId: session.id
        }).populate('courseId', 'title thumbnail').sort({
            downloadedAt: -1
        }).lean();
...
async function POST(request) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$OfflineContent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__OfflineContent$3e$__["OfflineContent"].findOne({
            userId: session.id,
            courseId,
        ...
        const offlineContent = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$OfflineContent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__OfflineContent$3e$__["OfflineContent"].create({
            userId: session.id,
            courseId,
...
async function DELETE(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const content = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$OfflineContent$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__OfflineContent$3e$__["OfflineContent"].findOneAndDelete({
            _id: contentId,
            userId: session.id
        });
        if (!content) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ce9f8ba7._.js.map