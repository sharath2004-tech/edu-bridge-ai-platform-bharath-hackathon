...
"[project]/app/api/super-admin/analytics/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        // Basic stats
        const [totalSchools, activeSchools, totalStudents, totalTeachers, totalPrincipals, totalClasses, totalSubjects, totalExams] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$School$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments(),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$School$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
                isActive: true
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
                role: 'student'
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
                role: 'teacher'
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Class$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments(),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Subject$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments(),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Exam$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments()
        ]);
        // Students per school
        const studentsBySchoolData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: {
                    role: 'student'
                }
        ...
        // Teachers per school
        const teachersBySchoolData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: {
                    role: 'teacher'
                }
        ...
        const studentsByGradeData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: {
                    role: 'student'
                }
        ...
        // Schools by board
        const schoolsByBoardData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$School$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $group: {
                    _id: '$board',
                    count: {
        ...
        const classStrengths = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Class$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $group: {
                    _id: null,
                    avgStrength: {
        ...
        const avgClassSize = classStrengths[0]?.avgStrength ? Math.round(classStrengths[0].avgStrength) : 0;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__743bda90._.js.map