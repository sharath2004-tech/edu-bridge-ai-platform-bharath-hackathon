...
async function POST() {
    try {
        ...
        // Clear existing data - drop collections to avoid unique constraint issues
        const collections = [
            'users',
            'schools',
            'classes',
        ...
        for (const collectionName of collections){
            try {
                await __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connection.db.dropCollection(collectionName);
            } catch (error) {
            ...
            for(let i = 0; i < 20; i++){
                ...
                for (const exam of classExams){
                    for (const subject of classSubjects){
                        ...
                        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Mark$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Mark$3e$__["Mark"].create({
                ...
                for(let d = 30; d > 0; d--){
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Attendance$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Attendance$3e$__["Attendance"].create({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00aee6a2._.js.map