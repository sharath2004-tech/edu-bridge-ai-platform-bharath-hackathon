...
"[project]/app/super-admin/students/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SuperAdminStudentsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SuperAdminStudentsPage.useEffect": ()=>{
            ...
            fetch(`/api/super-admin/users?${params}`).then({
                "SuperAdminStudentsPage.useEffect": (res)=>res.json()
            }["SuperAdminStudentsPage.useEffect"]).then({
                "SuperAdminStudentsPage.useEffect": (data)=>{
                    if (data.success) setStudents(data.users);
                    setLoading(false);
                }
            }["SuperAdminStudentsPage.useEffect"]).catch({
                "SuperAdminStudentsPage.useEffect": ()=>setLoading(false)
            }["SuperAdminStudentsPage.useEffect"]);
        }
    }["SuperAdminStudentsPage.useEffect"], [
        schoolFilter,
...
_s(SuperAdminStudentsPage, "a582v806ZcQqTiJ+s7fInYaLAGk=");
_c = SuperAdminStudentsPage;
var _c;
__turbopack_context__.k.register(_c, "SuperAdminStudentsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_4389145d._.js.map